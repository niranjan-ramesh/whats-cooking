...
useless_words = ['bag', 'box', 'bunch', 'can', 'cup', 'cups',
                 'dash', 'dozen', 'drop', 'envelope', 'fluid', 'g', 'gallon',
                 'head', 'inch', 'jar', 'kg', 'kgs', 'large', 'lb', 'lbs',
                 'leaf', 'liter', 'loaf', 'medium', 'ml', 'ounce', 'ounces',
                 'package', 'packages', 'packet', 'packets', 'pinch', 'pint',
                 'pints', 'quart', 'quarts', 'scoop', 'scoops', 'sheet',
                 'sheets', 'slice', 'slices', 'small', 'sprig', 'sprigs',
                 'stalk', 'stalks', 'tablespoon', 'tablespoons', 'teaspoon',
                 'teaspoons', 'or', 'whole'
                 ]
...
dfrec2 = dfrec1.rename(columns={"title": "name", "id": "id",
                                ...
                                "Directions": "steps"})
allrecdf = dfrec2[['name', 'id', 'minutes',
                   'contributor_id', 'Nutrition', 'steps', "Ingredients"]]
...
allrecdfin = allrecdf[['name', 'id', 'minutes', 'contributor_id',
                       'nutrition', 'n_steps', 'steps', "ingredients",
                       "n_ingredients"]]
...
revfinal.to_csv('temp/full_allrecipes_reviews.csv',
