...
nut['nutrients'] = nut['nutrients'].apply(
    lambda x: x.replace("empty", "['abc']"))
...
dfid = dfid.rename(columns={"recipe_name": "name",
                   "recipe_id": "id", "nutrients": "nutrition"})
finaldf = dfid[['name', 'id', 'minutes', 'contributor_id',
                'nutrition', 'n_step', 'steps',
